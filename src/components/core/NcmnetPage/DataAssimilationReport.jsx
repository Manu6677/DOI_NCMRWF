...
const reportLinks = [
  {
    id: 'dar-cycle-00z',
    label: 'NCUM Observations',
    url: '/t574-model/obs_monitor/Obs_Assimi.pdf',
  },
];
...
export default DataAssimilationReport;
